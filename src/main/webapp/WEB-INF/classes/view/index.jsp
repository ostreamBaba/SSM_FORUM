                    ...
                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        ...
                        <tr>
                            <td width="48px" valign="top" align="center" style="padding-top: 8px">
                                <img src="${pageContext.request.contextPath}/resources/image/${Article.articleUserName}.jpg" width="55px" height="55px"/>
                            </td>
                            <td width="15px"></td>
                                        ...
                                        <div class="votes"></div>
                                         <c:forEach items="${blocks}" var="block">
                                             <c:if test="${Article.blockId==block.blockId}">
                                                 <a class="node" href="/block/block-${Article.blockId}">${block.blockName}</a>
                                             </c:if>
                                         </c:forEach>
                                        &nbsp;•&nbsp;
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td width="auto" valign="middle">
                                    ...
                                    <span class="topic_info">
                                        <div class="votes"></div>
                                        <a class="node" href="#">java</a>
                                        &nbsp;•&nbsp;
                                        <strong>ostreamBaba</strong>
                                         &nbsp;•&nbsp; 最后回复时间:
                                        <strong>2018:12:12</strong>
                                    </span>
                                </td>
                                <td width="70px" align="right" valign="middle">
                                    <button class="btn btn-default" style="border: none     ">
                                        <span class="glyphicon glyphicon-pencil">&nbsp;2</span>
                                    </button>
                                </td>
                            </tr>
                        </tbody>
