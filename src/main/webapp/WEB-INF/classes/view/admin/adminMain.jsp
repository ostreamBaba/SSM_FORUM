            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="panel-title">
                        ...
                        <span style="font-size:14px;color: grey">&nbsp;&nbsp;管理员界面首页</span>
                    </div>
                </div>
                        ...
                        <div class="col-md-6">
                            <div class="well well-lg" style="background-color:white;">
                                <div style="font-size: 10px">
                                    ...
                                    style="color: #00b0ff">修改</span></a>
                                </div>
                                <hr>
                                <div>
                                    <span>论坛名称: Gucci Gang论坛</span>
                                </div>
                                <hr>
                                <div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="well well-lg" style="background-color:white;">
                                        ...
                                        <span style="margin-left: 15px;">${allUser}</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="well well-lg" style="background-color:white;">
                                        ...
                                        <span style="margin-left: 15px;">${allReply}</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="well well-lg" style="background-color:white;">
                                        ...
                                        <span style="margin-left: 15px;">${allArticle}</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="well well-lg" style="background-color:white;">
                                        ...
                                        <span style="margin-left: 15px;">${allBlock}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
