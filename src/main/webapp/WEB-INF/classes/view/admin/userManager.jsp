                            ...
                            $.ajax({
                                ...
                                success:function(data){
                                    if(data.userId == null){
                                        ...
                                        var msg="<tr id='tr1'><td>"+data.userId+"</td><td>"
                                            +data.username+"</td><td>"
                                            +data.password+"</td><td>"
                                            +data.email+"</td><tr>";
                                        $('#table').append(msg);
                                ...
                                <div class="col-md-12">
                                    <div class="well well-lg" style="background-color:white;">
                                        <table class="table" id="table">
                                            <tr><th>用户id</th><th>用户名</th><th>用户密码</th><th>用户邮箱</th></tr>
                                        </table>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="well well-lg" style="background-color:white;">
                                        <table class="table" id="table1">
                                            <tr><th>用户id</th><th>用户名</th><th>用户密码</th><th>用户邮箱</th>
                                            <th>操作</th></tr>
                                    ...
                                    <ul class="pager">
                                        <c:if test="${currentPage!=1}">
                                            <li class="previous"><a href="/user/findByPage?size=5&currentPage=${currentPage-1}">上一页</a></li>
                                        </c:if>
                                        <c:if test="${currentPage!=totalPage}">
                                            <li class="next"><a href="/user/findByPage?size=5&currentPage=${currentPage+1}">下一页</a></li>
                                        </c:if>
                                    </ul>
                                    <hr>
                                </div>
