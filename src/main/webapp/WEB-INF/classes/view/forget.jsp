        ...
        <div class="col-md-offset-2 col-md-6">
            <div class="login-block">
                ...
                <div class="col-lg-offset-4 alert alert-danger">
                    ...
                    <div class="col-lg-offset-4 alert alert-warning">
                        <strong>再次提示：我们会发送链接到您的邮箱进行验证重置密码</strong>
                    </div>
                <c:if test="${Msg == 'error'}">
                    <div class="col-lg-offset-4 alert alert alert-danger">
                        <strong>操作失误,请重试</strong>
                    </div>
                </c:if>
            </div>
            <%-- <%
            ...
            <script>
                ...
                function noEmpty(){
                    /*alert("test");*/
                    var t1=document.getElementById('email').value.length;
            ...
            <form class="form-horizontal" role="form" method="post" action="/user/forget" id="login-form">
                <div class="form-group">
                    <label for="email" class="col-lg-4 control-label">输入邮箱</label>
                    <div class="col-lg-8">
                        <input class="form-control" type="email" name="email" id="email" onblur="noEmpty()">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-lg-offset-4 col-lg-8">
                        <hr>
                        <button class="btn btn-primary btn-lg btn-block" type="submit" id="login" disabled>重置</button>
                        <br/>
                    </div>
                </div>
            </form>
